...
var RNGattCacheRefresh = react_native_1.NativeModules.RNGattCacheRefresh;
/**
 ...
 */
var refreshGattCache = function (deviceId) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, new Promise(function (resolve, reject) {
                ...
                RNGattCacheRefresh.refreshCache(deviceId, function (error, success) {
                    if (error) {
                        console.error("Error refreshing GATT cache: ".concat(error));
                        reject(error);
                    }
                    else {
                        resolve(success);
